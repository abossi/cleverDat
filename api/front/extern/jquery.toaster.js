...
(function ($,undefined)
{
	var toasting =
	{
		...
		notify : function (title, message, priority)
		{
			...
			{
				var timeout = (typeof settings.timeout === 'number') ? settings.timeout : ((typeof settings.timeout === 'object') && (priority in settings.timeout)) ? settings.timeout[priority] : 2000;
				setTimeout(function()
				{
